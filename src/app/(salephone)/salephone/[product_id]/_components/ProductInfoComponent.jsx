        ...
        <>
            <Box w={6} h={6}>
                <svg width="100%" height="100%" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.3333 20.6667H19.715C25.5114 20.6667 26.393 17.0253 27.4622 11.7143C27.7705 10.1824 27.9247 9.41646 27.5539 8.90617C27.1831 8.39587 26.4723 8.39587 25.0507 8.39587H7.75" stroke="#7F3A8A" strokeWidth="1.5" strokeLinecap="round" />
                    <path d="M10.3333 20.6667L6.94749 4.54016C6.65998 3.39014 5.62669 2.58337 4.44129 2.58337H3.22913" stroke="#7F3A8A" strokeWidth="1.5" strokeLinecap="round" />
                    <path d="M11.47 20.6667H10.9386C9.17757 20.6667 7.75 22.1538 7.75 23.9882C7.75 24.2939 7.98793 24.5417 8.28143 24.5417H22.6042" stroke="#7F3A8A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    <circle cx="13.5625" cy="26.4792" r="1.9375" stroke="#7F3A8A" strokeWidth="1.5" />
                    <circle cx="22.6041" cy="26.4792" r="1.9375" stroke="#7F3A8A" strokeWidth="1.5" />
                </svg>
            </Box>
        </>
    )
