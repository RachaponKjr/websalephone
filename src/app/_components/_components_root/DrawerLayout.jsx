                                ...
                                <Flex flexDirection={'column'} gap={2} w={'full'}>
                                    ...
                                    <Link href={'/about'}>
                                        <Flex bg={pathName === '/about' ? '#7F3A8A' : 'white'} alignItems={'center'} gap={2} p={2} rounded={'lg'} w={'full'}>
                                            <Box w={'20px'} h={'20px'}>
                                                <svg width="100%" height="100%" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M9 12V9M9 6H9.0075M16.5 9C16.5 13.1421 13.1421 16.5 9 16.5C4.85786 16.5 1.5 13.1421 1.5 9C1.5 4.85786 4.85786 1.5 9 1.5C13.1421 1.5 16.5 4.85786 16.5 9Z" stroke={pathName === '/about' ? 'white' : '#7F3A8A'} stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                            </Box>
