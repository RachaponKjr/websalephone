                        ...
                        <Grid gridTemplateColumns={{ base: 'repeat(2,1fr)', md: 'repeat(1,1fr)' }} h={'full'} gap={{ base: 2, md: 4 }} p={2}>
                            <GridItem display={"flex"} flexDirection={'column'} bgColor={{base:"#ffffff",md:"#FAFAFA"}} boxShadow={"rgba(0, 0, 0, 0.16) 0px 1px 4px"} p={2}>
                                ...
                                <Box w={'full'} px={{base:0,md:2,lg:4}}>
                                    <Text as={'p'} fontSize={{ base: '9px', md: '13px' }} textAlign={'center'} >
                                        ไม่มีรอยขีดข่วน/ หน้าจอไม่มีรอย/ แสดงภาพหน้าจอปกติ/ เครื่องไทย TH / หมดประกัน/ อุปกรณ์ครบ/ แบตเตอรี่ ต่ำกว่า 80%/ ระบบสัมผัส/
                                    </Text>
                                </Box>
                                <Box display={{base:'none',md:'block'}} w={'full'} h={1} my={2} bg={"#ffffff"}></Box>
                                <Box fontSize={'12px'} fontWeight={'bold'} mt={2} flexGrow={{base:0,md:1}} display={'flex'} justifyContent={'end'} alignItems={'center'}>
                                    <Text fontSize={{ base: '12px', md: '18px' }}>ยอดรวมสุทธิ : <Text as={'span'} color={'red'}>3,025</Text> บาท</Text>
                                </Box>
                            </GridItem>
                            <GridItem display={"flex"} flexDirection={'column'} bgColor={{base:"#ffffff",md:"#FAFAFA"}} boxShadow={"rgba(0, 0, 0, 0.16) 0px 1px 4px"} p={2}>
                                <Flex flexDirection={{base:"column",md:"row"}} gap={{base:0,md:3}}>
                        ...
                        <Flex flexDirection={'column'} gap={{base:2,md:4}} px={{base:6,md:2}} py={2}>
                            ...
                            <HStack spacing={0} mt={3}>
                                <Box mr={4} minW="4rem" h={'1.5rem'} display={'flex'} alignItems={'center'} justifyContent={'end'}>
                                    <Text as={'h6'} fontSize={{base:'12px',md:'14px'}} fontWeight={'bold'}>ข้อมูล</Text>
                                </Box>
                                <Input h={'2rem'} fontSize={{base:12,md:14}} placeholder='ชื่อ - นามสกุล' />
                            </HStack>
                            {/* ช้อมูลที่อยู่ */}
                            <HStack spacing={0}>
                                <Box mr={4} minW="4rem" h={'1.5rem'} display={'flex'} alignItems={'center'} justifyContent={'end'}>
                                    <Text as={'h6'} fontSize={{base:'12px',md:'14px'}} fontWeight={'bold'}>ที่อยู่</Text>
                                </Box>
                                <Input h={'2rem'} fontSize={{base:'12px',md:'14px'}} placeholder='หากต้องการขายด่วน กรุณาติดต่อ 092-123-4567' />
                            </HStack>
                            {/* ช้อมูลจังหวัด */}
                            <HStack spacing={0}>
                                <Box mr={4} minW="4rem" h={'1.5rem'} display={'flex'} alignItems={'center'} justifyContent={'end'}>
                                    <Text as={'h6'} fontSize={{base:'12px',md:'14px'}} fontWeight={'bold'}>จังหวัด</Text>
                                </Box>
                                <Flex gap={2}>
                                    <Input h={'2rem'} fontSize={{base:'12px',md:'14px'}} placeholder='กรุงเทพมหานคร' />
                                    <Input h={'2rem'} fontSize={{base:'12px',md:'14px'}} placeholder='เขตพระนคร' />
                                </Flex>
                            </HStack>
                            {/* ช้อมูลวัน/เวลา */}
                            <HStack spacing={0}>
                                <Box mr={4} minW="4rem" h={'1.5rem'} display={'flex'} alignItems={'center'} justifyContent={'end'}>
                                    <Text as={'h6'} fontSize={{base:'12px',md:'14px'}} fontWeight={'bold'}>วัน/เวลา</Text>
                                </Box>
                                <Flex gap={2}>
                                    <Input h={'2rem'} fontSize={{base:'12px',md:'14px'}} placeholder='วันที่' />
                                    <Input h={'2rem'} fontSize={{base:'12px',md:'14px'}} placeholder='เวลา' />
                                </Flex>
                            </HStack>
                            {/* ช้อมูลโทรศัพท์ */}
                            <HStack spacing={0}>
                                ...
                                <Input h={'2rem'} fontSize={{base:'12px',md:'14px'}} placeholder='เบอร์โทรศัพท์' />
                            </HStack>
                            ...
                            <HStack spacing={0}>
                                ...
                                <Input h={'2rem'} fontSize={{base:'12px',md:'14px'}} placeholder='ยืนยันเบอร์โทรศัพท์' />
                            </HStack>
                            ...
                            <Flex gap={2} alignItems={'start'} mt={2} pl={4}>
                                ...
                                <Flex flexDirection={'column'} fontSize={{base:'12px',md:'14px'}}>
                            ...
                            {/* ปุ่มยืนยัน */}
                            <Flex justifyContent={'center'} h={{base:'1.6rem',md:'2.5rem'}} mt={4} mb={{base:8,md:4}}>
                                <Button w={'6rem'} h={'100%'} color={'white'} bg={'#7F3A8A'} onClick={() => nextStep(3)}>ยืนยัน</Button>
                            </Flex>
                        </Flex>
                    </Box>
                </Flex>
